    ...
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        <div style={styles.welcome}>
          ...
          <span style={styles.roleBadge}>Lister</span>
        </div>
        ...
        <div style={styles.cardGrid}>
          ...
          <div style={styles.statCard}>
            <div style={styles.statNum}>0</div>
            <div style={styles.statLabel}>Enquiries received</div>
          </div>
          <div style={styles.statCard}>
            <div style={styles.statNum}>0</div>
        ...
        <div style={styles.emptySection}>
          ...
          <p style={styles.comingSoon}>Listing creation coming in Week 2</p>
        </div>
      </main>
    </div>
  );
...
const styles = {
  ...
  roleBadge: { fontSize:"11px", fontWeight:500, padding:"3px 10px", borderRadius:"20px", background:"#EAF3DE", color:"#27500A" },
